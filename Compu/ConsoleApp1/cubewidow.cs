...
public class CubeWindow : GameWindow
{
    ...
    protected override void OnLoad()
    {
        ...
        _teclado2 = new Objeto(0f, -0.5f, 0f, teclado);
        _monitor = new Objeto(0.0f, 0.0f, 0.0f, monitor);
        _cpu = new Objeto(0f, 0f, 0f, cpu);
        List<Objeto> partes = new List<Objeto>();
        partes.Add(_teclado);
        partes.Add(_monitor);
        partes.Add(_cpu);
        _pc = new Objeto(0.5f, 0.5f, 0f, cpu, partes);
    ...
    protected override void OnRenderFrame(FrameEventArgs args)
    {
        ...
        _teclado2.Draw(mvp); // incluye teclado
        _pc.Draw(mvp);
